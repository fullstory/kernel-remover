...
patches_for_kernel() {
	case "$1" in
		2.6.21*)
			...
			PATCH+=( http://sidux.com/files/patches/2.6.21_drivers-ata-ata_piix-postpone-pata.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_kvm-19.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_defaults-fat-utf8.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_defaults-unicode-vt.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_libata-atiixp-ids.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_wireless.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_git-wireless-dev.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_mac80211-fixes.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_mac80211-scan-optimizations.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_bcm43xx-mac80211-fixes.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_git-iwlwifi.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3175_iwlwifi-irq_tasklet.patch )
