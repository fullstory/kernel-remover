...
patches_for_kernel() {
	case "$1" in
		...
		2.6.22*)
			...
			PATCH+=( $PATCH_MIRROR/2.6.22-1.3240_git-wireless-dev.patch.bz2 )
			PATCH+=( $PATCH_MIRROR/2.6.22-1.3240_defaults-fat-utf8.patch.bz2 )
			PATCH+=( $PATCH_MIRROR/2.6.22-1.3240_defaults-unicode-vt.patch.bz2 )
			PATCH+=( $PATCH_MIRROR/2.6.22-1.3240_input-kill-stupid-messages.patch.bz2 )
