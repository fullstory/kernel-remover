...
patches_for_kernel() {
	case "$1" in
		2.6.21*)
			...
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3116-git-wireless-dev.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3116-git-iwlwifi.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3116-git-iwlwifi-fixes.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3116-zd1211rw-mac80211-queue-limit.patch )
			PATCH+=( http://sidux.com/files/patches/at76_usb-mac80211.diff )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3116-libata-sata_nv-adma.patch )
