...
patches_for_kernel() {
	case "$1" in
		...
		2.6.21*dscape*)
			...
			PATCH+=( http://sidux.com/files/patches/experimental/2.6.21-libata-sata_nv-adma.patch )
			PATCH+=( http://sidux.com/files/patches/experimental/2.6.21-git-wireless-dev.patch )
			PATCH+=( http://sidux.com/files/patches/experimental/2.6.21-git-iwlwifi.patch )
			PATCH+=( http://sidux.com/files/patches/experimental/2.6.21-git-iwlwifi-fixes.patch )
			PATCH+=( http://sidux.com/files/patches/experimental/2.6.21-zd1211rw-mac80211-queue-limit.patch )
			;;
		2.6.21*)
			PATCH+=( http://gaugusch.at/acpi-dsdt-initrd-patches/acpi-dsdt-initrd-v0.8.4-2.6.21.patch )
			PATCH+=( http://sidux.com/files/patches/t-sinus_111card-2.6.16.diff )
