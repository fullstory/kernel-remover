...
patches_for_kernel() {
	case "$1" in
		2.6.21*)
			...
			PATCH+=( http://sidux.com/files/patches/2.6.21-at76_usb20070511.diff.bz2 )
			...
			PATCH+=( http://sidux.com/files/patches/2.6.21-zr364xx.diff.bz2 )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_kvm-19.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_xfs-umount-fix.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_defaults-fat-utf8.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_defaults-unicode-vt.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_libata-hpa.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_libata-sata_nv-adma.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_libata-ali-atapi-dma.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_libata-sff-pci_iomap-bug.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_libata-sata_nv-wildcard-removal.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_wireless.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_git-wireless-dev.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_git-iwlwifi.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_highres-dyntick-avoid-xtime-lock-contention.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_clocksource-fix-resume-logic.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_acpi-keep-tsc-stable-when-lapic-timer-c2-ok-is-set.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_clockevents-fix-resume-logic.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_timer-tick-broadcast.patch )
			PATCH+=( http://sidux.com/files/patches/2.6.21-1.3142_acpi-clear-fadt_cstate-control.patch )
